      ...
      <v-row>
        ...
        <v-col :cols="8">
          <v-tabs-items v-model="tab">
            <v-tab-item :class="{ active: index == currentIndex }"
              v-for="(tutorial, index) in tutorials"
              :key="index"
              @click="setActiveTutorial(tutorial, index)"
            >
              <v-card flat>
                <v-card-subtitle>{{ tutorial.cfieldgoal }}   </v-card-subtitle>
                <v-card-text>{{ tutorial.gd_2_ctent }}  </v-card-text>
              </v-card>
            </v-tab-item>
          </v-tabs-items>
        </v-col>
...
<v-container fluid>
      <v-row dense>
        ...
        <div class="grid grid-cols-2 ">
           <!-- <v-card-title class="bg-bule-200"  >  -->

             <div v-if=" tutorial.temp_sort === '1.1' ">{{ tutorial.temp_sort }} </div>
        ...
        <div>
             ...
             <v-card-text><div>{{ tutorial.gd_2_ctent }}   </div> </v-card-text>
